...
<template>
    <div class="flex items-center justify-center flex-col py-10 bg-primary">
        <h1 class="text-5xl font-bold m-4 text-secondary">Board</h1>
        <img src="../assets/groupPhoto.jpg" class="w-8/12 max-md:w-11/12 mb-10 rounded-sm shadow-lg"
